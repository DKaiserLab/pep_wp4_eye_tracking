...
for iCate = 1:length(cfg.categories)
    ...
    for analysis_name = cfg.analysis_names
        ...
        gen1 = squareform(all_images_rdm(trp_idx==1, trp_idx==1));
        gen2 = squareform(all_images_rdm(trp_idx==2, trp_idx==2));
        gen3 = squareform(all_images_rdm(trp_idx==3, trp_idx==3));
